...
"""
import urllib, simplejson, sys, httplib2
...
class RunAPITest:
  ...
  def main(self):
    ...
    code = input("Enter code (parameter of URL): ")
    ...
    serv_req = urllib.Request(url="https://accounts.google.com/o/oauth2/token",
       data=data)

    serv_resp = urllib.urlopen(serv_req)
